package com.liquor.store.onliqst.security;

import com.liquor.store.onliqst.models.Role;
import com.liquor.store.onliqst.models.User;
import com.liquor.store.onliqst.repositories.UserRepository;
